  ...
  "facility-recruitment": {
    ...
    levels: [
      { cost: 2000, constructionDays: 3,  effects: ["신규 지원자 등장", "가입 심사 기능 해금"],
        recruitment: { dailyChance: 0.30, minApplicants: 1, maxApplicants: 1, capacity: 5 } },
      { cost: 4000, constructionDays: 7,  effects: ["지원자 수 증가"],
        recruitment: { dailyChance: 0.50, minApplicants: 1, maxApplicants: 2, capacity: 8 } },
      { cost: 9000, constructionDays: 14, effects: ["희귀 직업 확률 증가"],
        recruitment: { dailyChance: 0.65, minApplicants: 1, maxApplicants: 3, capacity: 12 } },
    ],
