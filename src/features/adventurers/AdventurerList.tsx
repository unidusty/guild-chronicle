...
import { getActiveAdventurers } from "../../game/simulation/selectors";
  ...
  return (
    <div>
      <div className="filter-bar">
        ...
        <select className="filter-select" value={filterRace} onChange={(e) => setFilterRace(e.target.value)}>
        ...
        <span className="filter-bar-count">{filtered.length}명 / 전체 {all.length}명</span>
      </div>
